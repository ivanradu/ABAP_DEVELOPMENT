...
annotate my_new_projectSrv.Customers with @UI.HeaderInfo: { TypeName: 'Customer', TypeNamePlural: 'Customers' };
annotate my_new_projectSrv.Customers with @UI.DataPoint #name: {
  Value: name,
  Title: 'Name',
};
annotate my_new_projectSrv.Customers with @UI.DataPoint #email: {
  Value: email,
  Title: 'Email',
};
annotate my_new_projectSrv.Customers with @UI.DataPoint #customerNumber: {
...
annotate my_new_projectSrv.Customers with @UI.HeaderFacets: [
...
annotate my_new_projectSrv.Products with @UI.HeaderInfo: { TypeName: 'Product', TypeNamePlural: 'Products' };
annotate my_new_projectSrv.Products with @UI.DataPoint #name: {
  Value: name,
  Title: 'Name',
};
...
annotate my_new_projectSrv.Products with @UI.HeaderFacets: [
 { $Type : 'UI.ReferenceFacet', Target : '@UI.DataPoint#name' }
];
